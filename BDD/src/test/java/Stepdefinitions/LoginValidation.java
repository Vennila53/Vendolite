...
public class LoginValidation {
	...
	public void open_the_browser() {
		System.setProperty("webdriver.edge.driver", "C:/Users/user/eclipse-workspace/BBD/src/test/resources/Drivers/chromedriver.exe");
		driver = new ChromeDriver();
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	}
	@Then("user is navigated to login page")
	public void user_is_navigated_to_login_page() {
		driver.navigate().to("https://cloud-test.vendolite.com/home/login");
		System.out.println("Cloud test page is navigated");
	}
